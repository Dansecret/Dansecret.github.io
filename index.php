...
<head>
  ...
  <title>Portsmedia|Hamdandih</title>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Hamdandih</h1>
      <p>I'm <span class="typed" data-typed-items="Web Developer, Freelancer, Collage Student"></span></p>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>I am a hardworking, unyielding and innovative person, my hobby is playing basketball, 
            in terms of work I am very professional, thorough and responsible, can work in a team or individually,
             I am committed to always completing the given task, 
            accept constructive criticism and happy to keep learning</p>
        </div>

        <div class="row">
          <div class="col-lg-4">
            <img src="assets/img/dandi.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            <!-- <h3>Software Developer &amp; Web Developer.</h3> -->
            <h3>Collage Student</h3>
            <!-- <p class="fst-italic">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              ...
              <p>Achievment</p>
              <ul>
                <li>3rd Place Kontes Robot Sepakbola Humanoid, regional level 1 in 2021</li>
                <li>4rd Place Kontes Robot Sepakbola Humanoid, National in 2021</li>
              </ul>
            </div>
            <div class="resume-item pb-0">
            <h4>Automotive vocational high School</h4>
              <h5>2016-2019</h5>
              <p><em>SMK N 1 LAHAT, Sumatera Selatan, INDONESIA</em></p>
              <p>Achievment</p>
              <ul>
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              <h4>Barista & Cook</h4>
              <h5>2021 - 2022</h5>
              <p><em>Wande coffe Galery, Daerah Istimewa Yogyakarta </em></p>
              <ul>
                <li>Serving Coffee</li>
                <li>Maintain, Operate and Understand Coffee Tools</li>
                <li>Maintain the cleanliness of the shop / cafe</li>
                <li>Mixing Non-Coffee Drinks</li>
                <li>Understanding the Cashier System</li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>Apprentice Mechanic</h4>
              <h5>2018</h5>
              <p><em>PT.ASTRA INTERNATIONAL DAIHATSU tbk. ,Sumatera-Selatan</em></p>
              <ul>
                <li>Responsible and assist the main mechanic in carrying out the services that will be carried out on the vehicle</li>
                <li>Ensure the vehicle is safe to be driven by the customer after service</li>
              </ul>
            </div>
          </div>
